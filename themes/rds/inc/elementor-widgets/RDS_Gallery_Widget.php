...
if ( $data && is_numeric( $data['id'] ) ) {             
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section("rds_gallery_widget", [
			"label" => esc_html__(
		...
		if (!empty($this->allVariation) && count($this->allVariation) > 1) {
			$defaultVariation = isset($args["page_templates"]["gallery_page"]["variation"]) ? $args["page_templates"]["gallery_page"]["variation"] : "a";
