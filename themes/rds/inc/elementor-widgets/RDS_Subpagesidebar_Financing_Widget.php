...
public $widgetPathFull;
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $this->widgetPath = "easy-financing/subpage-sidebar"; //Edit
    ...
    protected function register_controls()
    {
        ...
        if (!empty($this->allVariation) && count($this->allVariation) > 1) {
            $defaultVariation = isset($args["page_templates"]["subpage"]["sidebar"]["financing"]["variation"]) ? $args["page_templates"]["subpage"]["sidebar"]["financing"]["variation"] : "a";
