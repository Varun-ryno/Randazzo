...
if ( $data && is_numeric( $data['id'] ) ) {             
		...
		$this->widgetPath = "careers/career-header";
    ...
    */
    ...
    protected function register_controls() {
        ...
        $this->add_control('widget_1_heading', array('label' => 'Heading', 'type' => \Elementor\Controls_Manager::TEXTAREA, 'default' => 'Join Our Team',));
        $this->add_control('widget_1_subheading', array('label' => 'Sub Heading', 'type' => \Elementor\Controls_Manager::TEXTAREA, 'default' => 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit.',));
        $this->add_control('widget_1_content', array('label' => 'Content', 'type' => \Elementor\Controls_Manager::WYSIWYG, 'default' => 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit.',));
